...
for i in range(50):
    ...
    bloque = Bloque(NEGRO, 20, 15,"pelota.png")
...
protagonista = Protagonista(ROJO, 20, 15,"pacman.png")
listade_todoslos_sprites.add(protagonista)

#Crear la funcion para mostrar los puntos
def puntos(puntuacion):
    text = letra.render ("Puntos:  " +str(puntuacion), True, NEGRO)
...
while not hecho:
    ...
    #Dibujar los puntos en el juego    
    puntos(puntuacion)
